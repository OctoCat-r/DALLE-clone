...
const PostCreate = () => {
  ...
  const API_KEY = "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";

  const handleChange = (e) => {
    setForm({ ...form, [e.target.name]: e.target.value });
  };

  console.log(form, "aman");
      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        <div className="flex flex-col gap-5">
          ...
          <FormField
            ...
            type="text"
            name="prompt"
            placeholder="A rabbit sleeping on the mountain edge"
            value={form.prompt}
            handleChange={handleChange}
            isSurpriseMe
          ...
          <div className="relative bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-64 p-3 h-64 flex justify-center items-center">
            ...
            {generatingImg && (
              <div className="absolute inset-0 z-0 flex justify-center items-center bg-black bg-opacity-40  rounded-lg">
                <Loader />
              </div>
            )}
          </div>
        ...
        <div className="mt-10">
          <p className="mt-2 text-[#666e85] text-[14px]">
            Once the image is created you can share it with others in your
            community!
          </p>
          <button
            type="submit"
